	...
	**/
	final class PgSQL extends DB
	{
		...
		**/
		...
		{
			return UUIDUtils::generate( UUIDUtils::UUID_TIME, UUIDUtils::FMT_STRING, 'onphp' );
		}
		...
		**/
		...
		public function queryRaw($queryString)
		{
			try {
				if(
					defined( 'PATH_PGSQL_QUERY_PROFILING_FILE' )
				){
					file_put_contents(PATH_PGSQL_QUERY_PROFILING_FILE, date('Y-m-d H:i:s', time() ).': '.$queryString."\n", FILE_APPEND);
				}
