	...
	**/
	final class Primitive extends StaticFactory
	{
		...
		**/
		...
		{
			return new PrimitiveUniversalUniqueString($name);
		}
		...
		**/
		...
		{
			return new PrimitiveUniversalUniqueIdentifier($name);
		}
		...
		**/
		...
		{
			return new PrimitiveUniversalUniqueIdentifierList($name);
		}
		...
		**/
		...
		/**
		 * @return PrimitiveHstoreList
		**/
		public static function hstoreList($name)
		{
			return new PrimitiveHstoreList($name);
		}
		...
		**/
		 ...
		 */
		public static function emailList($name)
		{
			return new PrimitiveEmailList($name);
		}
		...
		{
			return new PrimitiveCaptcha($name);
		}
		
		/**
		 * @param string $name
		 * @return PrimitiveFileList
		 */
		public static function fileList($name)
		{
			return new PrimitiveFileList($name);
		}
	}
?>