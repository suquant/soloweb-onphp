 ...
 ***************************************************************************/
	...
	define('LOGGER_PORT', 5672);
	define('LOGGER_LOGIN', 'guest');
	define('LOGGER_PASSWORD', 'guest');
	define('LOGGER_VIRTUAL_HOST', '/');
	define('LOGGER_EXCHANGER', 'LoggerExchange');
	define('LOGGER_QUEUE', 'LoggerMainQueue');
	define('LOGGER_ROUTING_KEY', 'logger');
	...
	set_include_path(
		...
		.'Acl'.DIRECTORY_SEPARATOR.PATH_SEPARATOR


		.ONPHP_INCUBATOR_PATH
		.'classes'.DIRECTORY_SEPARATOR
		.'FormRendering'.DIRECTORY_SEPARATOR.PATH_SEPARATOR
		.ONPHP_INCUBATOR_PATH
		.'classes'.DIRECTORY_SEPARATOR
		.'FormRendering'.DIRECTORY_SEPARATOR.'ControlMapping'.DIRECTORY_SEPARATOR.PATH_SEPARATOR
		.ONPHP_INCUBATOR_PATH
		.'classes'.DIRECTORY_SEPARATOR
		.'FormRendering'.DIRECTORY_SEPARATOR.'Controls'.DIRECTORY_SEPARATOR.PATH_SEPARATOR
	...
	/*
		...
		.ONPHP_INCUBATOR_PATH
		.'classes'.DIRECTORY_SEPARATOR
		.'TSearch'.DIRECTORY_SEPARATOR.PATH_SEPARATOR

		.ONPHP_INCUBATOR_PATH
		.'classes'.DIRECTORY_SEPARATOR
		.'OQL2'.DIRECTORY_SEPARATOR.PATH_SEPARATOR

		.ONPHP_INCUBATOR_PATH
		.'classes'.DIRECTORY_SEPARATOR
		.'OQL2'.DIRECTORY_SEPARATOR
		.'Grammar'.DIRECTORY_SEPARATOR.PATH_SEPARATOR

		.ONPHP_INCUBATOR_PATH
		.'classes'.DIRECTORY_SEPARATOR
		.'OQL2'.DIRECTORY_SEPARATOR
		.'Parsers'.DIRECTORY_SEPARATOR.PATH_SEPARATOR

		.ONPHP_INCUBATOR_PATH
		.'classes'.DIRECTORY_SEPARATOR
		.'OQL2'.DIRECTORY_SEPARATOR
		.'Parsers'.DIRECTORY_SEPARATOR
		.'Tokenizer'.DIRECTORY_SEPARATOR.PATH_SEPARATOR

		.ONPHP_INCUBATOR_PATH
		.'classes'.DIRECTORY_SEPARATOR
		.'OQL2'.DIRECTORY_SEPARATOR
		.'SyntaxTree'.DIRECTORY_SEPARATOR.PATH_SEPARATOR

		.ONPHP_INCUBATOR_PATH
		.'classes'.DIRECTORY_SEPARATOR
		.'OQL2'.DIRECTORY_SEPARATOR
		.'SyntaxTree'.DIRECTORY_SEPARATOR
		.'Criteria'.DIRECTORY_SEPARATOR.PATH_SEPARATOR

		.ONPHP_INCUBATOR_PATH
		.'classes'.DIRECTORY_SEPARATOR
		.'OQL2'.DIRECTORY_SEPARATOR
		.'SyntaxTree'.DIRECTORY_SEPARATOR
		.'Iterators'.DIRECTORY_SEPARATOR.PATH_SEPARATOR

		.ONPHP_INCUBATOR_PATH
		.'classes'.DIRECTORY_SEPARATOR
		.'OQL2'.DIRECTORY_SEPARATOR
		.'SyntaxTree'.DIRECTORY_SEPARATOR
		.'Mutators'.DIRECTORY_SEPARATOR.PATH_SEPARATOR

		.ONPHP_INCUBATOR_PATH
		.'classes'.DIRECTORY_SEPARATOR
		.'OQL2'.DIRECTORY_SEPARATOR
		.'SyntaxTree'.DIRECTORY_SEPARATOR
		.'Statements'.DIRECTORY_SEPARATOR.PATH_SEPARATOR
